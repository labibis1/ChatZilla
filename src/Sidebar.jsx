        ...
        <div>
          <nav className="flex flex-col bg-sky-600 w-64 h-screen px-[30px] m-[30px] tex-gray-900 rounded-[20px]  border-black shadow-2xl">
            <div className=" mt-8 mx-auto">
              <div className="">
                <img src="labib.jpg" className=" w-30 h-30 rounded-full  " />
              </div>
              <div className="mx-auto">
                <p className=" text-white flex justify-center mt-[10px]">
                  Labib
                </p>
              </div>
            </div>
            <div className="mt-10 mb-4">
              <ul className="ml-4">
                ...
                8-4z"
                  ...
                  <a href="#">
                    <span className="ml-2">Friend Request</span>
                  </a>
                </li>
                ...
                8-4z"
                  ...
                  <a href="#">
                    <span className="ml-2">Block List</span>
                  </a>
                </li>
